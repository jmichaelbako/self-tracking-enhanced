...
namespace EnhancedEntities
{
    ...
    public static class ObjectWithChangeTrackerExtensions
    {
    	...
    	public static T Clone<T>( this T trackingItem )	where T : IObjectWithChangeTracker
    	{
    		var serializer = new DataContractSerializer( trackingItem.GetType() );
    		var memoryStream = new MemoryStream();
    
    		serializer.WriteObject( memoryStream, trackingItem );
